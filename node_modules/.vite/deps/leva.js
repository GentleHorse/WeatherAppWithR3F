...
var $cf1ac5d9fe0e8206$export$bc4ae5855d3c4fc = (0, import_react13.forwardRef)((props3, forwardedRef) => {
  ...
  const [arrow3, setArrow] = (0, import_react13.useState)(null);
...
function usePopin(margin = 3) {
  ...
  const hide2 = (0, import_react23.useCallback)(() => setShow(false), []);
  (0, import_react23.useLayoutEffect)(() => {
    if (shown) {
      const {
        bottom,
